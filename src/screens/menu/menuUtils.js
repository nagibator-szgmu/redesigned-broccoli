...
export const makeCatMeta = (t) => ({
  ...
  gastro: { icon: React.createElement(IconGastro, { size: 20, color: BRAND_BLUE }), label: t("spec.gastro"), color: BRAND_BLUE },
});
...
export const makeNavSpec = (t) => [
  ...
  { icon: React.createElement(IconGastro, { size: 16, color: BRAND_BLUE }), label: t("spec.gastro"), cat: "gastro" },
];
