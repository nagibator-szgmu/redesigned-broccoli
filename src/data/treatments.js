import { ADVERSE_REASONS, TREAT_NOTES } from "./treatmentsMeta.js";

export { ADVERSE_REASONS, TREAT_NOTES };
...
export const TREAT_FX = {
  ...
  omeprazole_iv:{eff:{pain:-2},             delay:60,  desc:"Антисекреторное (ИПП)"},
  octreotide:   {eff:{sbp:5,hr:-4},         delay:60,  desc:"Снижение портального давления"},
  endoscopic_hemostasis:{eff:{sbp:15,hr:-8},delay:120, desc:"Эндогемостаз"},
...
export const TREATMENTS = [
  ...
  {id:"omeprazole_iv",name:"Омепразол в/в (ингибитор протонной помпы)",cat:"gastro"},
  {id:"octreotide",name:"Октреотид в/в",cat:"gastro"},
  {id:"endoscopic_hemostasis",name:"Эндоскопический гемостаз",cat:"intervention"},
