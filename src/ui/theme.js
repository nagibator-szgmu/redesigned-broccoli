...
export const DARK = {
  bg:"#0B0F19", panel:"#131D2E", panel2:"#18263D",
  border:"rgba(59,130,246,0.16)", borderBright:"rgba(59,130,246,0.32)",
  ...
  text:"#E2E8F0", textDim:"#8FA0B8", white:"#FFFFFF",
  // semantic backgrounds
  bgGrad:"linear-gradient(160deg,#0B0F19 0%,#111A29 50%,#0B0F19 100%)",
  panelBg:"rgba(19,29,46,0.85)", panelBg2:"rgba(24,38,61,0.92)",
  headerBg:"rgba(11,15,25,0.94)", headerBg2:"rgba(11,15,25,0.80)",
  sidebarBg:"rgba(19,29,46,0.92)",
  overlayBg:"rgba(11,15,25,0.98)",
  inputBg:"rgba(19,29,46,0.75)",
  dimBg:"rgba(37,99,235,0.06)",
  btnBg:"rgba(37,99,235,0.08)", btnBorder:"rgba(59,130,246,0.22)",
