export const DARK = {
  ...
  accent:"#00e6c8", accentDim:"rgba(0,61,58,0.5)",
  green:"#00e5a0", greenDim:"rgba(0,61,40,0.45)",
  red:"#ff3d5a",   redDim:"rgba(77,0,24,0.45)",
...
export const LIGHT = {
  bg:"#f0f5f9", panel:"#ffffff", panel2:"#f3f7fc",
  border:"#dde7ef", borderBright:"#c6d8e8",
  accent:"#009e88", accentDim:"#e0f7f4",
  green:"#008c70", greenDim:"#e0f5ec",
  ...
  headerBg:"rgba(236,243,250,0.96)", headerBg2:"rgba(236,243,250,0.82)",
